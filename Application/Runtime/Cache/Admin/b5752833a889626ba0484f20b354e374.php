            ...
            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                   <?php if(is_array($pageData["list"])): foreach($pageData["list"] as $key=>$record): ?><tr>
                            ...
                            <td class="center"><?php echo ($params['role'][$record['usertype']]); ?></td>
                            <td><?php echo ($record["username"]); ?></td>
                            <td><?php echo ($record["uid"]); ?></td>
                            <td><?php echo ($record["dowhat"]); ?></td>
                            <td><?php echo ($record["doip"]); ?></td>
                            <td><?php echo (date("Y-m-d H:i:s",$record["dotime"])); ?></td>
