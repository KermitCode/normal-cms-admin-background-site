...
<script src="<?php echo ($baseUrl['imgUrl']); ?>jquery_17min.js"></script>
        ...
        <div class="table-responsive">
            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                   ...
                   <?php if(is_array($pageData["list"])): foreach($pageData["list"] as $key=>$record): ?><tr>
                            <td class="center"><?php echo ($record["uid"]); ?></td>
                            <td class=""><?php echo ($record["username"]); ?></td>
                            <td><?php echo ($record["phone"]); ?></td>
                            <td><a title="徒弟列表"  href="/admin/user/disciple.html?uid=<?php echo ($record["uid"]); ?>"><?php echo ($record["tudi_num"]); ?></a></td>
                            <td><a title="金币明细" href="/admin/money/jinbi.html?uid=<?php echo ($record["uid"]); ?>"><?php echo ($record["golds"]); ?></a></td>
                            <td><?php echo ($record["change_golds"]); ?></td>
                            <td><a title="现金明细" href="/admin/money/lingqian.html?uid=<?php echo ($record["uid"]); ?>"><?php echo $record['money']/100;?>元</a></td>
                            <td><a title="提现记录" href="/admin/money/tixian.html?uid=<?php echo ($record["uid"]); ?>"><?php echo $record['out_cash']/100;?>元</a></td>
                            <td>
                                <?php echo $record['weixin_id'] ? '<span style="color:green">是</span>' : '<span style="color:red">否</span>'; ?>
                            </td>
                            <td><?php echo (date("Y-m-d H:i:s",$record["addtime"])); ?></td>
                            <td><a href="/admin/user/view.html?uid=<?php echo ($record["uid"]); ?>">详情</a></td>
