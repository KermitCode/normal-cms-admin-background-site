...
<!--                <th>锁定</th>-->
	...
	<tbody>
        ...
        <?php if(is_array($data)): foreach($data as $key=>$row): ?><tr>
            ...
            <td><?php echo ($params['nooryes'][$row['hidden']]); ?></td>
            <td><?php echo ($row["sortnum"]); ?></td>
        <!--    <td><?php echo ($params['nooryes'][$row['fix']]); ?></td>-->
            <td><?php echo ($row["fixurl"]); ?></td>
            <td>
                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                   <button class="btn btn-xs btn-info" onclick="window.location.href='<?php echo U('/Admin/Menu/modify',array('id'=>$row['id']));?>'" <?php ?>>
