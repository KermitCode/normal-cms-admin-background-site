...
<table id="sample-table-1" class="table table-striped table-bordered table-hover">
	...
	<tbody>
	    <?php if(is_array($pageData["list"])): foreach($pageData["list"] as $key=>$row): ?><tr>
            <td><?php echo ($row["id"]); ?></td>
			<td><?php echo ($row["setname"]); ?></td>
            <td><?php echo ($row["config_name"]); ?></td>
            <td><?php echo ($row["config_key"]); ?></td>
            <td><?php echo ($platSet['htmltype'][$row['config_htmltype']]); ?></td>
			<td><?php echo ($row["sortnum"]); ?></td>
            <td><?php echo ($params['status'][$row['config_disable']]); ?></td>
