    ...
    <div class="col-sm-12" style="background-color:#fff;">
        ...
        <div class="panel-body" style="padding-top:10px;padding-bottom:0px;">
            <div style="border-bottom:1px solid #ddd;padding-bottom:5px;">
                ...
                <?php if(isset($rightRow['child']) && $rightRow['child']){ if($key=='signup'){?>
				...
				<?php }else{ foreach($rightRow['child'] as $skey=>$srow){?>
							<span style="display:inline-block;width:175px;margin-left:10px;">
        ...
        <?php }?>
        <input type="hidden" name="thisId" value="<?php echo ($adminer['id']); ?>"/>
    </div>
